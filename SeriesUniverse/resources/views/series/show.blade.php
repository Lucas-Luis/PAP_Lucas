        ...
        <div class="col-sm-8 single-left">
            <div class="song">
                ...
                <div class="video-grid-single-page-agileits">
                    <div data-video="dLmKio67pVQ" id="video"> <img src="{{asset('storage/images/articles').'/'.$serie->imagem}}" alt=""
        ...
        <div class="song-grid-right">
                <div class="share">
                    <h5>Sobre a Serie</h5>
                        ...
                        <ul>
                            <li>
                            <strong>Data lançamento:</strong> {{$serie->ano_lancamento}}</li>
                            <li><strong>Realizador:</strong> {{$serie->realizador}}</li>
                            <li><strong>Temporadas:</strong> {{$serie->temporadas}}</li>
                            <li><strong>Plataforma:</strong> {{$serie->plataforma->nome}}</li>
                            <li><strong>Categoria:</strong> {{$serie->categoria->genero}}</li>
                            <li><strong>Resumo:</strong> {{$serie->descricao}}</li>
                            <li><strong>Elenco:</strong> {{$serie->elenco}}</li>
                            <li><strong>Avaliação:</strong> {{$serie->avaliacao}}</li>
                            <p> <strong>triler:</strong></p><a href=" " target="_blank">{{$serie->trailer}}</a>
